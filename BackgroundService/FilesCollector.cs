...
namespace BackgroundService
{
    public class FilesCollector : IFilesCollector
    {
        ...
        private readonly IPdfNotificationService _pdfNotificationService;
        ...
        public FilesCollector(IServiceProvider provider)
        {
            ...
            _emailNotificatioNService = scope.ServiceProvider.GetRequiredService<IEmailNotificatioNService>();
            _pdfNotificationService = scope.ServiceProvider.GetRequiredService<IPdfNotificationService>();
            _smsNotificationService = scope.ServiceProvider.GetRequiredService<ISmsNotificationService>();
